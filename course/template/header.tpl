<?php
    ...
    $id = "";
    $mode = "";
	if(isset($_SESSION['user_name'])&&isset($_SESSION['kuid'])||isset($_SESSION['power']))
	{
                ...
                <div class="body-nav body-nav-horizontal body-nav-fixed">
                     <div class="container">
                         <ul>
							...
							<li><a href="courselist.php"><i class="icon-list icon-large"></i> <?php echo $MSG_Courses;?></a></li>
							<li><a href="status.php"><i class="icon-pencil icon-large"></i> <?php echo $MSG_Status;?></a></li>
							<!-- -->
							<li><a href="ranklist.php"><i class="icon-bar-chart icon-large"></i> <?php echo $MSG_Ranklist;?></a></li>
