    ...
    if(isset($_POST['loadExcel']) && !empty($_POST['loadExcel']))
	{
		...
		if($result) //如果上传文件成功，就执行导入excel操作
		{
			...
			for ($row = 2;$row <= $highestRow;$row++) 
			{
                ...
                $strSql = "insert into exam_user (`eid`, `uid`) VALUES
                                     ('".$a1."','".$a2."');";
    ...
    <div class="row">
		...
		<div class="span12">
			<div id="Person-1" class="box">
				...
				<form action="addbatchexamuser.php" method="post" enctype="multipart/form-data">
				...
				<div class="box-content box-table">
					<table class="table table-hover table-bordered">
						<tbody>
							<tr>
								<td width="10%">下载模板</td>
								<td width="50%"><a href="../app/examstudents.xls">名单模板</a></td>
								<td width="40%"></td>
							</tr>
							<tr>
								<td width="10%">名单文件</td>
