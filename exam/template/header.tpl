<?php
    ...
    $id = "";
    $mode = "";
	if(isset($_SESSION['user_name'])&&isset($_SESSION['euid'])||isset($_SESSION['power']))
	{
...
<head>
    ...
    <link href="include/vendors/bootstrap-wysihtml5-rails-b3/vendor/assets/stylesheets/bootstrap-wysihtml5/core-b3.css" rel="stylesheet" media="screen">
                ...
                <div class="body-nav body-nav-horizontal body-nav-fixed">
                     <div class="container">
                         <ul>
							...
							<li><a href="examlist.php"><i class="icon-list icon-large"></i> <?php echo $MSG_Exam;?></a></li>
							<li><a href="status.php"><i class="icon-pencil icon-large"></i> <?php echo $MSG_Status;?></a></li>
							<!--
							<li><a href="ranklist.php"><i class="icon-bar-chart icon-large""icon-bar-chart icon-large"></i> <?php echo $MSG_Ranklist;?></a></li>
							-->
							<li><a href="#"><i class="icon-list-alt icon-large"></i><?php echo $MSG_Forum;?></a></li>
							<li><a href="#"><i class="icon-info-sign icon-large"></i> <?php echo $MSG_About?></a></li>
						 </ul>
                     </div>
                </div>
