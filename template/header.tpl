                ...
                <div class="container">
                    <div id="app-nav-top-bar" class="nav-collapse">
                        ...
                        <ul class="nav pull-right">
							<li>
                                <a href="../exercise/login.php">Login</a>
                            </li>
                             <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Language</a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="change.php?lang=cn">中文</a>
                                        </li>
                                        <li>
                                            <a href="change.php?lang=en">English</a>
                                        </li>
                                    </ul>
                                </li>
							<li>
                ...
                <div class="body-nav body-nav-horizontal body-nav-fixed">
                     <div class="container">
                         <ul>
							...
							<li><a href="exam/examlist.php"><i class="icon-screenshot icon-large"></i> <?php echo $MSG_Exam;?></a></li>
							<li><a href="course/courselist.php"><i class="icon-tasks icon-large"></i> <?php echo $MSG_Courses;?></a></li>
							<li><a href="exercise/problemlist.php"><i class="icon-check icon-large"></i> <?php echo $MSG_Problems;?></a></li>
